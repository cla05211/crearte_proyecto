-- productos_pedidos.beneficio se dropeó en 20260924120000_crear_beneficios_pedido.
-- modificar_plan_pedido todavía insertaba esa columna, así que fallaba al
-- editar el plan. Misma función, sin la columna beneficio (los beneficios
-- viven en beneficios_pedido y editar el plan no los toca).
